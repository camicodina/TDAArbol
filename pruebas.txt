...
bool mostrar_elemento(int elemento, void* extra){
...
void prueba_iterador_interno(){
    abb_t* arbol =arbol_crear(comparar_contenido,NULL);
    int c=6,a1=2,m=7,i=9,l=3,a2=1;

    arbol_insertar(arbol,&c);
    arbol_insertar(arbol,&a1);
    arbol_insertar(arbol,&m);
    arbol_insertar(arbol,&i);
    arbol_insertar(arbol,&l);
    arbol_insertar(arbol,&a2);

    pa2m_afirmar(abb_con_cada_elemento(arbol, ABB_RECORRER_INORDEN, mostrar_elemento, NULL); == 4, "Iterador OK");
